...
export type Pokemons_CountQuery = {
  __typename?: 'Query';
  pokemons: { __typename?: 'PokemonConnection'; limit: number; count: number };
};
...
export const Pokemons_CountDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'pokemons_count' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'limit' } },
...
} as unknown as DocumentNode<Pokemons_CountQuery, Pokemons_CountQueryVariables>;
export const Pokemon_TypesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'pokemon_types' },
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<Pokemon_TypesQuery, Pokemon_TypesQueryVariables>;
